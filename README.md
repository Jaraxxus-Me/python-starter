...
### Set Up the Code
2. **Clone this repository** and give it the name of your repo: `git clone https://github.com/Jaraxxus-Me/python-starter.git <NAME>`. You now have a directory called NAME. **Enter** it: `cd <NAME>`.
